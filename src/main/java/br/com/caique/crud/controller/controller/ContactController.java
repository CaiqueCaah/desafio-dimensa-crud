...
public class ContactController {
	...
	@ApiResponses(value = { 
			...
			@ApiResponse(responseCode = "500", description = "Erro interno no sistema") })
	@PutMapping(value = "/{id}")
	public ContactResponseDTO update(@RequestBody ContactResponseDTO contactRequestDTO, @PathVariable Long id) {
	...
	@DeleteMapping("{id}")
	public ContactResponseDTO delete(@PathVariable Long id) {
		ContactResponseDTO contactDeleted = contactService.delete(id);
